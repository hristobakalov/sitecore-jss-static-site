...
const Layout = ({ route }) => (
  <React.Fragment>
    ...
    <Helmet>
      ...
      <meta http-equiv="Content-Security-Policy" content="script-src 'self' http://onlineerp.solution.quebec 'unsafe-inline' 'unsafe-eval'; style-src 'self' jss-bestpractice-149060-cd.azurewebsites.net"></meta> 
    </Helmet>
